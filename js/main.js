$(document).ready(function() {
	...
	var obj = {
        ...
        'Przestępstwa lekkie': {
			...
			'Podszywanie się pod funkcjonariusza LAPD': {
                'Dodatkowe': '',
                'Kwota min': 5000,
                'Kwota max': 5000,
                'Więzienie min': 15,
			...
			'Usiłowanie zabójstwa funkcjonariusza LAPD': {
                'Dodatkowe': 'Konfiskata licencji na broń',
                'Kwota min': 20000,
                'Kwota max': 40000,
                'Więzienie min': 25,
			...
			'Napaść na funkcjonariusza LAPD': {
                'Dodatkowe': '',
                'Kwota min': 10000,
                'Kwota max': 20000,
                'Więzienie min': 15,
	...
	$("body").append('<div class="footer"><p>Taryfikator LAPD</p></div>');
